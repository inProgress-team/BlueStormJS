...
module.exports = {
    ...
    start: function(dev, debug) {
        ...
        if (dev)
            this.mongo = (require(__dirname + '/' + dataBaseConfig.type))(dataBaseConfig.hostDev);
        else
            this.mongo = (require(__dirname + '/' + dataBaseConfig.type))(dataBaseConfig.hostProd);
    }
